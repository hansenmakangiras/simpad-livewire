<div>
  ...
  <x-card class="card">
    <x-card-header>
      <h4 x-data="{ message: 'Kick start your next project 🚀' }" class="card-title" x-text="message"></h4>
      <h1 x-data="{ pesan: 'I ❤️ Alpine' }" x-text="pesan"></h1>
    </x-card-header>
